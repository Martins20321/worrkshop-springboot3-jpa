...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		prodRepository.saveAll(Arrays.asList(p1,p2,p3,p5,p5));
		...
		OrderItem oi1 = new OrderItem(o1, p1, 2, p1.getPrice()); //Apenas reproduzindo o preço do produto
